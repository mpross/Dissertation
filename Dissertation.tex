...
the many professors and teachers that steered me towards studying physics, especially C.D. Hoyle, Erik Kramer, and Steve Hoffman;
...
Much of the work presented here is open-source. The BRS image analysis software can be found here: \url{https://github.com/mpross/BRSReadout}. The BRS controls software can be found here: \url{https://github.com/mpross/BRS-Controls}. The CAD models of the BRS can be found here: \url{}. The CAD model of the autocollimator can be found here: \url{}.

The CAD models of the cBRS can be found here: \url{}. The readout and controls software for the cBRS can be found here: \url{https://github.com/mpross/cBRS_Controls}.
...
\caption[Differential platform motion ]{Differential platform motion as measured by the capacitive position sensors (CPS) for the Y-Arm of LHO with and without the BRSs installed. Below $\sim$30~mHz, the CPS reading is driven to zero by the control system. Adapted from~\cite{windproofing}.}
\label{armMotion}
\end{center}
\end{figure}
