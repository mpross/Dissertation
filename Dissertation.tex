...
\end{center}
\caption{Close up view of the center of the CAD rendering of the BRS. One of the copper colored flexures can be seen at center along with its clamps. The two gray block at the top are mirrors for optical sensing, one fixed to the support the other attached to the beam.}
\end{figure}
...
\begin{figure}[!h]
\begin{center}
 \includegraphics[width=\textwidth]{cBRS_TransferFunction3.pdf}
\caption{}
...
To decrease the effects of air currents and gas damping, each BRS is placed into its own vacuum chamber which emulates the outline of the device, as shown in Figure \ref{BRSPic}.
